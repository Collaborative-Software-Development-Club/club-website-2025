...
import { Users, CalendarCheck2, CheckCircle2, Gavel } from "lucide-react"

export default function Page() {
  const featured = (projects as Project[]).filter((p) => home.featuredProjectIds.includes(p.id)).slice(0, 3)

  const timeline: TimelineStep[] = [
    { title: "Attend pitches + onboarding", desc: hiw.meetings.firstMeeting, icon: Users },
    {
      title: "Build weekly with your team",
      desc: `${hiw.meetings.mandatory} ${hiw.meetings.optional}`,
      icon: CalendarCheck2,
    },
    { title: "Meet eligibility & attendance", desc: hiw.attendance.summary, icon: CheckCircle2 },
    { title: "Leadership & elections", desc: `${hiw.leadership.executiveBoard} ${hiw.elections.summary}`, icon: Gavel },
  ]
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 grid gap-6">
          <div>
            ...
            <p className="mt-4 text-lg text-zinc-300 max-w-2xl">{home.hero.subtitle}</p>
            <div className="mt-6">
      ...
      <section className="container mx-auto px-4 pb-16">
        <MeetingCallout dayTime="Wednesdays at 6pm" location="Enarson Classroom Building" />
      </section>
    </>
  )
}
